...
export class AssetsComponent implements OnInit {
  ...
  // displayedColumns: string[] = ['screenshot', 'fileType', 'name', 'preview', 'description', 'auditoriumNum', 'createdAt', 'actions'];
  displayedColumns: string[] = ['fileType', 'preview', 'description', 'actions'];
  ...
  addAsset(): void {
    this.dialog.open(AssetAddModalComponent, {});
  }

  editAsset(asset): void {
    const editModal = this.dialog.open(AssetEditModalComponent, {
      data: asset
    });
